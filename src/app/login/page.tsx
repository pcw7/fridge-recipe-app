...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-1 items-center justify-center px-4 py-12">
      ...
      >
        <h1 className="text-xl font-semibold tracking-tight text-slate-800 dark:text-cyan-50">로그인</h1>
        <input
          type="email"
          required
          value={email}
        ...
        <p className="text-center text-sm text-slate-600 dark:text-cyan-100/70">
          계정이 없으신가요?{" "}
          <Link href="/signup" className="font-medium text-cyan-700 underline dark:text-cyan-300">
            회원가입
          </Link>
        </p>
      </form>
